...
export function VendorSignupForm() {
  const [state, formAction] = useActionState(vendorSignupAction, initialFormState);
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        ...
        <FieldError message={state.fieldErrors?.businessName?.[0]} />
      </div>
      ...
      <SubmitButton pendingText="Creating account…">Create vendor account</SubmitButton>
